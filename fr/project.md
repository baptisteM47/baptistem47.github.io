...
Vous trouverez ici un aperçu de l'ensemble des projets réalisés au cours de mes études et de mon temps personnel.

## <a id="project-empirical-m2"></a> Projet 1 — Empirical M2

- Objectif : Ce projet vise à analyser l'impact de l'incertitude climatique sur les investissements verts des entreprises.
...
- Objectif : L'objectif de ce projet est de prédire quand les entreprises vont faire défaut et d'identifier les composantes qui impactent le plus le taux de défaut.
- [Results / Report :](https://baptistem47.github.io/Scoring_project/)
- Statut : Terminé

## <a id="project-python"></a> Project 3 - Python 

- Objectif : L'objectif de ce projet est d'analyser « Comment les chocs macroéconomiques tels que la politique monétaire, le PIB, la consommation, l'investissement et l'inflation affectent-ils la courbe des taux zéro-coupon des gouvernements de la zone euro pour plusieurs maturités ? ». L'objectif est de comprendre non seulement l'impact global de ces chocs sur la courbe des taux de la zone euro, mais aussi comment leurs effets varient le long de la structure par terme pour les maturités courtes, intermédiaires et longues.
...
- Objectif : Ce projet examine l'impact des chocs de dépenses publiques sur l'activité économique, en se concentrant sur le PIB réel, la consommation réelle et l'indice d'incertitude de la politique économique. À partir de données trimestrielles américaines de 1947 à 2015.
...
- Objectif : Ce projet vise à évaluer l'efficacité économique et sociale du projet NH1 en comparant les coûts et les bénéfices sur une période de 25 ans.
...
- Objectif : Ce projet consiste à résoudre trois exercices basés sur différents concepts réels à l'aide de méthodes économétriques.
...
- Objectif : L'objectif de ce projet était d'analyser l'impact de l'activité de trading sur la volatilité et la liquidité intrajournalières à l'aide des modèles GARCH et HAR.
...
- Objectif : L'objectif de ce projet était d'utiliser des méthodes d'analyse des risques extrêmes pour analyser le comportement des valeurs extrêmes dans la population des villes américaines.
...
- Objectif : L'objectif de ce projet est d'évaluer l'impact des facteurs socioéconomiques sur les troubles de santé mentale aux États-Unis. Il utilisera le jeu de données MH-CLD de 2018 à 2022.
